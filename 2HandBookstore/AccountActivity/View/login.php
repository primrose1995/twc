						...
						<div class="inner">
							...
							<!-- Table -->
								<section>
									...
									<form method="post" action="../control/login_connect.php">
									<div class="field half">
										會員帳號<input type="text" name="id"  placeholder="帳號	" />
										
									</div>
									<div class="field half">
										密碼<input type="password" name="pw" placeholder="密碼" />
									</div>
									...
									<ul class="actions">
										<li><input type="submit" value="登入" class="special" /></li>
									</ul>
								</form>
				           </section>
						</div>
